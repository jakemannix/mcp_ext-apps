/**
 * Descent Game - MCP App Wrapper
 *
 * Handles MCP App connection and passes all relevant props to the game component.
 */
...
import DescentGame from "./game/DescentGame.tsx";
import "./global.css";
...
function McpAppWrapper() {
  ...
  const { app, error } = useApp({
    appInfo: { name: "Descent", version: "1.0.0" },
    capabilities: {},
    onAppCreated: (app) => {
