  ...
  return (p: p5) => {
    ...
    const createWrapper = () => {
      ...
      boundMethods.ctx = {
        ...
        get pwinMouseX() {
          return _p.pwinMouseX;
        },
        get pwinMouseY() {
          return _p.pwinMouseY;
        },
        get mouseButton() {
          return _p.mouseButton;
        },
        get mouseIsPressed() {
          return _p.mouseIsPressed;
        },
        get movedX() {
          return _p.movedX;
        },
        ...
        get keyIsPressed() {
          return _p.keyIsPressed;
        },
        get touches() {
          return _p.touches;
        },
        get frameCount() {
          return _p.frameCount;
        },
        get deltaTime() {
          return _p.deltaTime;
        },
        ...
        get windowWidth() {
          return _p.windowWidth;
        },
        get windowHeight() {
          return _p.windowHeight;
        },
        get width() {
          return _p.width;
        },
        ...
        get displayWidth() {
          return _p.displayWidth;
        },
        get displayHeight() {
          return _p.displayHeight;
        },
        get pixels() {
          return _p.pixels;
        },
