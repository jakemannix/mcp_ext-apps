...
/**
 * Host-side bridge for communicating with a single view ({@link app!App}).
 *
...
> {
   ...
   * @see {@link app!App.sendSizeChanged} - the view method that sends these notifications
   */
  set onsizechange(
   ...
   * @see {@link sendToolInput} for sending tool arguments to the view
   */
  set oninitialized(
